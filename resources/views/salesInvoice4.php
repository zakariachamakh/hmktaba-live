...
<body>
    <div class="invoice-box">
        <div style="width:100%;">
            <table style="width: 100%;border-bottom:2px solid blue">
                <tr style="vertical-align: top; width:40%">
                    <td style="text-align:left;width:20%;vertical-align:top;padding:0px">
                        <img src="{{ asset('images/nike.jpg') }}" style="width: 110px;height:100px;color:blue" />
                    </td>
        ...
        <div style="width: 100%;">
            <div style="width:50%;float:left">
                <table>
                    ...
                    <tr>
                        <td style="font-size:12px;text-align:left;font-weight:bold">{{'Place of Supply:'}} <span>{{ '07-Delhi' }}</span></td>
        ...
        <div style="width:50%;float:right">
            <table>
                ...
                <tr>
                    <span style="font-size: 12px;">{{ $company->name }}</span> <br>
                    <span style="font-size:12px">{{ $company->address }}</span><br>
                    <span style="font-size:12px">{{ $company->phone }}</span><br>
                </tr>
            </table>
        ...
        <div style="margin-top: 140px;">
            ...
            <table cellpadding="2px" cellspacing="0" style="font-size:14px; vertical-align: top;width:100%;">
                <tbody>
                    <tr class="item heading-tow" style="color:white;background-color:blue">
        ...
        <div>
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="text-align: right;font-size: 12px;">{{'$9272.00'}}</td>
                </tr>
            </table>
        </div>
        <div style="width: 100%">
            ...
            <div style="float: right;width:85%;">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;width:10%;font-size:9px">{{'For Nike'}}</td>
                    </tr>
                    <tr>
